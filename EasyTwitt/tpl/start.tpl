...
<div class="div-center spacing">
		...
		<div class="row spacing">
                    ...
                    [[if Commercial::checkCommercialDate($comm)==1]]
			<div class="col-sm-3">
                            <img src="[[$comm->filePath]]" alt="Commercial" style="width: 350px; height: 350px;" class="img-rounded img-responsive">
				<h3 class="twitter-blue"><strong>[[$comm->text]]</strong></h3>
				<p>[[CommercialDB::ReturnLocation($comm)->town]],[[CommercialDB::ReturnLocation($comm)->state]]</p>
			</div>
                    [[/if]]
                    [[/foreach]]
                    [[/if]]
						...
						<div class="col-md-6 mb-3" style="margin-top: 10px;">
							<label for="validationCustom03">City</label>
                                                        <select name="city" class="w3-select w3-border">
                                                            ...
                                                            <option value="[[$location->town]]">[[$location->town]]</option>
                                                            [[/foreach]]
                                                        </select>
						</div>
						<div class="col-md-6 mb-3" style="margin-top: 10px;">
