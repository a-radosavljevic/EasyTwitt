                ...
                <div class="w3-half">
                    ...
                    <div class="w3-container w3-card w3-white w3-margin-bottom">
                        ...
                        <div class="w3-container">
                            ...
                            <p><strong><i class="fa fa-star fa-fw w3-margin-right w3-large w3-text-red"></i>
                                    Name of event: <input type="text" name="txtName" placeholder="Events name" value="[[$event->name]]" required>
                                </strong></p>
                            <p>
                                <strong> Event info: <input type="text" name="txtInfo" placeholder="Give some info on event" value="[[$event->info]]" required=""> </strong>
                            </p>
							
							<input type="hidden" name="id" value="[[$event->id]]">
							<input type="hidden" name="noGuests" value="[[$event->noGuests]]">
							
                            <hr>
                            <h4><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                                Date: <input class="w3-input w3-border" type="date" name="eventDate" value="[[$dateVal]]"required> </h4>
                            <hr>
                    ...
                    <select name="selLok" class="w3-select w3-border">
                        [[foreach $locations as $location]]
							...
							<option value="[[$location->id]]" selected="selected">[[$location->town]],[[$location->state]]</option>
